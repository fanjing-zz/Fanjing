...
import {
  Project, ProjectStatus, SocialAccount, SocialPlatform, SocialAuthStatus,
  PROJECTS, SOCIAL_ACCOUNTS, PLATFORM_STYLE, AUTH_STATUS_STYLE,
} from './sharedData';
...
function buildReportHTML(theme: 'dark' | 'light' = 'dark'): string {
  ...
  const vars = dk ? {
    ...
    borderStrong: 'rgba(0,177,162,0.22)',
    bgSurface:    'rgba(0,0,0,0.18)',
    cardHeadBg:   'rgba(0,177,162,0.02)',
    gridColor:    'rgba(0,177,162,0.04)',
    titleGradTop: '#E8F4F0',
  } : {
    bgBase:       '#F6F9FA',
    bgPanel:      '#EDF2F4',
